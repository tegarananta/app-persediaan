...
class ItemsController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				items.id LIKE ? OR 
				items.part_number LIKE ? OR 
				items.description LIKE ? OR 
				items.category_id LIKE ? OR 
				items.brand_id LIKE ? OR 
				items.unit_of_measurement_id LIKE ? OR 
				items.price LIKE ? OR 
				items.image LIKE ?
			)";
			$search_params = array(
		...
		$page_title = $this->view->page_title = "Items";
	...
	function view($rec_id = null, $value = null){
		...
		if($record){
			$page_title = $this->view->page_title = "View  Items";
		$this->view->report_filename = date('Y-m-d') . '-' . $page_title;
		$this->view->report_title = $page_title;
		$this->view->report_layout = "report_layout.php";
		$this->view->report_paper_size = "A4";
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("part_number","description","category_id","brand_id","unit_of_measurement_id","price","image");
			...
			$this->sanitize_array = array(
				'part_number' => 'sanitize_string',
				'description' => 'sanitize_string',
				'category_id' => 'sanitize_string',
				'brand_id' => 'sanitize_string',
				'unit_of_measurement_id' => 'sanitize_string',
		...
		$page_title = $this->view->page_title = "Add New Items";
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","part_number","description","category_id","brand_id","unit_of_measurement_id","price","image");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'part_number' => 'required',
		...
		$page_title = $this->view->page_title = "Edit  Items";
		if(!$data){
			$this->set_page_error();
		}
