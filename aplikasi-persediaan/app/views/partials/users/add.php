                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="form-group ">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-8">
                                                                            <div class="">
                                                                                <input id="ctrl-updated_at"  value="<?php  echo $this->set_field_value('updated_at',""); ?>" type="number" placeholder="Enter Updated At" step="1"  required="" name="updated_at"  class="form-control " />
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
