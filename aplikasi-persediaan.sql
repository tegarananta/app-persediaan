...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 16, 2023 at 05:47 PM
...
CREATE TABLE `items` (
  ...
  `unit_of_measurement_id` char(36) NOT NULL,
...
(1, 'John Doe', 'mrama08282@gmail.com', 'admin', NULL, '$2y$10$MCSN.HrkRitV5emGHuAn3.OAnZXxWErpwsh4kJLTVjzkd54JsCW76', 'Admin', NULL, 1686930349, NULL),
(2, 'Jane Doe', 'janedoe@gmail.com', 'operator', NULL, '$2y$10$F.AaLkqDn9F7urm.ZdNlA.sZGcNAtrmjxEyKHD6Sa1K3F2H7HyKjG', 'Operator', NULL, 1686930349, NULL);
